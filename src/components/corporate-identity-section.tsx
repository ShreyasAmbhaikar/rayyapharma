...
export function CorporateIdentitySection() {
  return (
    <section className="relative overflow-hidden bg-surface-container-low py-xl">
      <div className="pointer-events-none absolute left-0 top-1/2 h-[800px] w-[800px] -translate-y-1/2 rounded-full bg-primary-fixed/40 blur-[100px]" />
      ...
      <div className="section-shell relative z-10">
        <div className="flex flex-col items-start gap-12 md:flex-row">
          ...
          <div className="reveal-soft reveal-delay-1 w-full rounded-xl border border-outline-variant/40 bg-surface-container-lowest/70 p-8 shadow-[var(--shadow-panel-soft)] backdrop-blur-xl md:w-2/3">

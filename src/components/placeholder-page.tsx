    ...
    <MarketingShell currentPath={page.path}>
      <section className="section-shell py-24 md:py-32">
        <div className="mx-auto max-w-4xl">
          <span className="pill-label mb-6">Static Placeholder Route</span>
          <h1 className="mb-6 font-h1 text-[clamp(2.5rem,5vw,4rem)] leading-tight text-primary">{page.title}</h1>
          <p className="mb-10 max-w-2xl font-body-lg text-body-lg text-on-surface-variant">{page.description}</p>
